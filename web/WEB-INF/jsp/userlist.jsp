        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/user/list.html">
					 <span>用户名：</span>
					 <input name="queryUserName" class="input-text"	type="text" value="${param.queryUserName }">
					 ...
					 <select name="queryUserRole">
						<c:if test="${roleList != null }">
						   ...
						   <c:forEach var="role" items="${roleList}">
						   		<option <c:if test="${role.id == param.queryUserRole }">selected="selected"</c:if>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${pageSupport.list }" varStatus="status">
					<tr>
						<td>
