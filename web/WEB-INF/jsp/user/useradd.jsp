...
<body>
<fm:form method="post" modelAttribute="user" action="/user/useraddsave.html">
	...
	用户生日:<fm:input path="birthday" Class="Wdate" readonly="readonly" onclick="WdatePicker();" class="Wdate"/><fm:errors path="birthday" /><br/>
	用户地址:<fm:input path="address"/><br/>
	联系电话:<fm:input path="phone"/><br/>
	性别：<fm:select path="gender">
			<fm:option value="1">男</fm:option>
			<fm:option value="0">女</fm:option>
		</fm:select>
	<br/>
用户角色:
